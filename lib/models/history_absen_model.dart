...
HistoryAbsenModel historyAbsenModelFromJson(String str) => HistoryAbsenModel.fromJson(json.decode(str));

String historyAbsenModelToJson(HistoryAbsenModel data) => json.encode(data.toJson());
...
class HistoryAbsenModel {
    ...
    factory HistoryAbsenModel.fromJson(Map<String, dynamic> json) => HistoryAbsenModel(
