...
DeleteAbsenModel deleteAbsenModelFromJson(String str) => DeleteAbsenModel.fromJson(json.decode(str));

String deleteAbsenModelToJson(DeleteAbsenModel data) => json.encode(data.toJson());
...
class DeleteAbsenModel {
    ...
    factory DeleteAbsenModel.fromJson(Map<String, dynamic> json) => DeleteAbsenModel(
