...
AbsenCheckOutModel absenCheckOutModelFromJson(String str) => AbsenCheckOutModel.fromJson(json.decode(str));

String absenCheckOutModelToJson(AbsenCheckOutModel data) => json.encode(data.toJson());
